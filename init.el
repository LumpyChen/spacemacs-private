...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Inziu IosevkaCC Slab SC"
                               :size 16
                               :weight bold
                               :width normal
                               :powerline-scale 1)
